    ...
    <>
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                From preparation to mastery – your ultimate interview tool.
              </p>
              <button
      ...
      <div className="w-full min-h-full relative z-10 "> 
        ...
        <section className="flex items-center justify-center -mt-72">
          <img src = {logo2} alt = "Hero Image" className="w-[80vw] rounded-lg border-2 border-amber-300"/>
      ...
      <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-5">Made by Siddhartha</div>
